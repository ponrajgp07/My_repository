...
const box2 = document.getElementsByClassName("sub-box2")
...
forms.addEventListener('submit',async (e)=>{
    ...
    if(inputs[0].value.trim() ===""){
        errors[0].textContent="Name is requird!";
    ...
    if(inputs[1].value.trim()==""){
        errors[1].textContent="Email is requird!";
    ...
    if(text[0].value.trim()==""){
        errors[2].textContent="Kindly share your meassges";
